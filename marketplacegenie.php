...
if (in_array('woocommerce/woocommerce.php', apply_filters('active_plugins', get_option('active_plugins')))) {
    ...
    function marketplacegenie_wooCommerceMenu()
    {
        ...
        add_submenu_page('marketplacegenie', 'Licensing', 'Licensing', 'manage_options', 'marketplacegenie_licence', 'marketplacegenie_licence_render');
        add_submenu_page('marketplacegenie', 'Support', 'Support', 'manage_options', 'marketplacegenie_support', 'marketplacegenie_support_render');

    }

    function marketplacegenie_support_render()
    {
     ?>
               <div class="container" style="margin-right: 50px; margin-left: 50px;">
                <div class="row">
                    <a class="m-portlet__body">
                        <img width="250px" src="/wp-content/plugins/marketplacegenie-api/img/logo.png"/> <br>

                        <h2>Support</h2>
                        <a target="_blank" href="/wp-content/plugins/marketplacegenie-api/public/takealot.pdf" <h4>Download Manual </h4> </a><br><br>

                    <a target="_blank" href=" https://www.youtube.com/playlist?list=PLHJgfRw9qE1VXD30ODNU1kTj9SDXVHKK7" <h4>Instructional Videos </h4> </a>
                        <h4> If you need any help, please dont hesitate to email us @ <a href="mailto:info@marketplacegenie.co.za?Subject=WooCommerce Plugin Support " target="_top">info@marketplacegenie.co.za</a></h4>
    ...
    function marketplacegenie_licence_render()
    {
        $admin_url = admin_url('admin-ajax.php');
        echo '<link rel="stylesheet" type="text/css" href="' . plugin_dir_url(__FILE__) . "/public/css/snap.css" . '">';
        registrationmodal();
        $ordernumber = esc_attr(get_option('marketplacegenie_api_key'));;
        $amount = "500";
        ?>
        <style>
            button {
                ...
                jQuery.ajax({
                    ...
                    success: function (response) {
                        try {
                            ...
                            console.error("APIKEY RESPONSE " + JSON.stringify(response))
        ...
        <header class="logo unknown-platform">
            <div class="logo"><img style=" height: 28px;   padding-top: 5px;"
                                   src="https://pos.snapscan.io/images/qr/titlebar_logo.png"/></div>
        </header>
        <div class="unknown-platform">

            <div class="content">
                <p>Scan the SnapCode to complete the payment.</p>
                <div id="snapscan-widget-wrapper">
                    <div id="snapscan-checkout-qr">
                        <div id="snapscan-qr-loading">Loading...</div>
                        <div id="snapscan-qr-image"
                        >
                            <a href="https://pos.snapscan.io/qr/marketplacegenie?id=<?= $ordernumber ?>&amount=<?= $amount ?>">
                                <img style="z-index: 0;"
                                     src="https://pos.snapscan.io/qr/marketplacegenie.svg?id=<?= $ordernumber ?>&amount=<?= $amount ?>&snap_code_size=150&strict=true">
                            </a>
                        </div>
                        <div id="snapscan-qr-caption"></div>
                    </div>
                </div>
                ...
                <div class="qr-card">
                    <div class="float-left">
                        <img id="icon"
                             src="https://assets.snapscan.io/uploads/merchants/icons/57213b876c96236af52f4ae15504f144-MarketplaceGeniePtyLtd-43fb7650d4c26459c936407a1278d021-marketplace_genie_logo_v0.1.0.png"
                             width="60">
                    </div>
                    <div class="float-left">
                        <h2>Marketplace Genie</h2>
                    </div>
                    <div style="clear:both"></div>
                    <div class="extras">
                        <p id="payment-id"><strong>PAYMENT ID:</strong> <?= $ordernumber ?></p>
                    </div>
                    <div id="payment-amount">
                        <strong>TOTAL: </strong>
                        <?php $number = $amount / 100;
                        //  setlocale(LC_MONETARY,"en_ZA");
                        ?>
                        <?= money_format('R %i', $number) ?>
                    </div>
                    <div class="indicator"></div>
                </div>
                <p><a target="_blank" href="https://www.snapscan.co.za">Learn more about SnapScan</a></p>
            </div>
        </div>
    ...
    function downloadmanual()
    {
        ...
        $submenu['marketplacegenie'][] = array(
            '<div id="downloadmanual">Support</div>', // <-- trick
            'manage_options',
    ...
    <div id="wf-onboarding-fresh-install" class="wf-onboarding-modal">
     <form method="post" action="options.php" id ="keyupdateform">
            ...
            <div id="wf-onboarding-fresh-install-1" class="wf-onboarding-modal-content">
                ...
                <h4>Please visit <a target="_blank" href="https://www.marketplacegenie.com/subscribe/marketplace/takealot/woocommerce?url=' . $siteurl . '/wp-admin/admin.php?page=marketplacegenie">marketplacegenie.com/register</a> to obtain  your API key.</h4>
                <div id="wf-onboarding-license">
                 
                 <input type="text" required placeholder="Enter API Key" style="min-width: 300px;" id="registrationkeymodal" name="marketplacegenie_api_key"  value="' . $marketplaceGenieApiKey . '" /></div>
                <div id="wf-onboarding-footer">
                    <ul>
                        <li>
                            <input type="checkbox" checked=checked style="display:none;" class="wf-option-checkbox wf-small" id="remember"> <label for="wf-onboarding-agree">By continuing , I agree to the Marketplace Genie (Pty) Ltd. <a href="https://www.marketplacegenie.com/legal/terms-and-conditions" target="_blank" rel="noopener noreferrer">terms</a> and <a href="https://marketplacegenie.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">privacy policy.</a></label>
                              </li>
                        <li><a  onclick="updatekey() ; return false;;"  href ="" class="primary button" style ="width:90px;" id="wf-onboarding-continue"> Continue </a></li>
                    </ul>
                </div>
...
<img width="250px" src="/wp-content/plugins/marketplacegenie-api/img/logo.png"/> <br>
    ...
    <form method="post" action="options.php"  > 
        <script src="https://toolhome.co.za/wp-content/plugins/marketplacegenie-api/public/js/raphael-min.js"></script>  
        <script src="https://toolhome.co.za/wp-content/plugins/marketplacegenie-api/public/js/jquery.min.js"></script>
        <script src="https://toolhome.co.za/wp-content/plugins/marketplacegenie-api/public/js/jquery.countdownring.js"></script>
        <style>
            #holder {
				position: absolute;
				left:100px;
		...
		$(function () {
			...
			var cdr = $('#holder').CountdownRing(360, 360, callback, options );
			// cdr.stop();
        ...
        <div id="welcomemessage"  style = "display:none !important;" class="updated woocommerce-message wc-connect">
        ...
        <table class="form-table">
            ...
            <tr valign="top">
            <th scope="row">License Key Status</th>
            <td id="apiKeyExpire">$apiKeyExpire</td>
        
        </tr>
        <tr valign="top">
       
            <th scope="row">License Period</th>
            <td id="apiKeyExpire">  <div id="holder"></div></td>
...
var modal = document.getElementById("myModal");
    jQuery.ajax({
        ...
        success: function (response) {
            try{ 
             //   console.error("APIKEY URL  " + '$admin_url');
             //      console.error("APIKEY RESPONSE " +JSON.stringify(response))
           //  console.error("APIKEY  " + jQuery('[name=marketplacegenie_api_key]').val());
            jQuery('#checkApiKey').html(response.status);
            jQuery('#apiKeyExpire').html( response.expire);
...
EOD;
            ...
            if ($MarketplacegenieTakealotTagExport == "on") {
                $MarketplacegenieTakealotTagExport = "checked";
            }
            $markup = <<<EOD
            <div class="wrap">
                ...
                <div class="row">
                    <div class="m-portlet__body">
                        ...
                        <div class="table-responsive users-table">
                            <a href="admin.php?page=marketplacegenie&cleartab=true&tab=log"> <input type="button"
                                                                                                    value="Clear Log"></a>
